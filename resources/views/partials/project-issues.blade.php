<div id="issues" class="mt-[50px] pl-[10px] w-[100%]">
    ...
    <div>
        <div class="grid grid-cols-9 gap-[10px] border bg-[#a5a5a5]">
            <div class="h-full border-r-[1px] flex justify-center items-center"><p>Link</p></div>
            <div class="h-full border-r-[1px] flex justify-center items-center"><p>Title</p></div>
            <div class="h-full border-r-[1px] flex justify-center items-center"><p>Status</p></div>
            <div class="h-full border-r-[1px] flex justify-center items-center"><p>Assignee</p></div>
            <div class="h-full border-r-[1px] flex justify-center items-center"><p>Due Date</p></div>
            <div class="h-full border-r-[1px] flex justify-center items-center"><p>Priority</p></div>
            <div class="h-full border-r-[1px] flex justify-center items-center"><p>Comments</p></div>
            <div class="h-full border-r-[1px] flex justify-center items-center"><p>Created At</p></div>
            <div class="h-full border-r-[1px] flex justify-center items-center"><p>Updated At</p></div>
        </div>
        @if ($issues->count() > 0)
