<x-layout>
    <div>
        ...
        <form action="/projects/create" method="POST" class="flex flex-col gap-[10px] w-[300px]">
            @csrf
            <div class="flex flex-col">
                <label for="name" class="mb-[5px]">Project Name</label>
                <input type="text" name="name" id="name" class="border-[1px] rounded px-[5px] py-[3px]"
                    required>
            ...
            <div class="flex flex-col">
                ...
                <input type="date" name="deadline" id="deadline" class="border-[1px] rounded px-[5px] py-[3px]"
                    required>
            ...
            <button type="submit" class="bg-blue-500 text-white rounded px-[10px] py-[5px] mt-[10px]">Create
                Project</button>
        </form>
    </div>
</x-layout>
